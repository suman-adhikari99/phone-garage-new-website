...
export const stores: Store[] = [
  {
    ...
    suburb: "Burwood",
    phone: "(02) 9745 1234",
    email: "burwood@phonegarage.com.au",
    hours: "Mon-Fri 9am-6pm, Sat 10am-4pm",
    rating: 4.8,
    reviewCount: 342,
    mapUrl: "https://maps.google.com/?q=Burwood+NSW",
  },
  {
    id: "newtown",
    name: "Newtown",
    ...
    suburb: "Newtown",
    phone: "(02) 9557 5678",
    email: "newtown@phonegarage.com.au",
    hours: "Mon-Fri 9am-6pm, Sat 10am-4pm",
    rating: 4.9,
    reviewCount: 287,
    mapUrl: "https://maps.google.com/?q=Newtown+NSW",
  },
  {
    id: "parramatta",
    name: "Parramatta",
    ...
    suburb: "Parramatta",
    phone: "(02) 9633 9101",
    email: "parramatta@phonegarage.com.au",
    hours: "Mon-Fri 9am-6pm, Sat 10am-4pm",
    rating: 4.7,
    reviewCount: 198,
    mapUrl: "https://maps.google.com/?q=Parramatta+NSW",
  },
  {
    id: "adelaide",
    name: "Adelaide",
    ...
    suburb: "Adelaide",
    phone: "(08) 8232 1122",
    email: "adelaide@phonegarage.com.au",
    hours: "Mon-Fri 9am-6pm, Sat 10am-4pm",
    rating: 4.8,
    reviewCount: 156,
    mapUrl: "https://maps.google.com/?q=Adelaide+SA",
  },
]

export const reviews = [
  { id: "r1", name: "Sarah M.", rating: 5, text: "Incredible service! My iPhone screen was fixed in under 30 minutes. The quality is just like new.", store: "Burwood" },
  { id: "r2", name: "James T.", rating: 5, text: "Best repair shop in Sydney. Fair prices, fast turnaround, and they actually explain what they're doing.", store: "Newtown" },
  { id: "r3", name: "Lisa K.", rating: 5, text: "Thought my phone was gone after water damage. They saved everything including my data. Highly recommend.", store: "Parramatta" },
  { id: "r4", name: "David R.", rating: 4, text: "Quick battery replacement for my Samsung. Phone feels brand new again. Great warranty too.", store: "Adelaide" },
  { id: "r5", name: "Emma W.", rating: 5, text: "Professional, transparent pricing, and incredibly fast. Won't go anywhere else for phone repairs.", store: "Burwood" },
  { id: "r6", name: "Michael P.", rating: 5, text: "Camera was completely broken after a drop. Fixed same day with genuine parts. Outstanding work.", store: "Newtown" },
]
